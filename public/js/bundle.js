...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  var _locations$0$coordina = _slicedToArray(locations[0].coordinates, 2),
    longStart = _locations$0$coordina[0],
    latStart = _locations$0$coordina[1];
  var map = L.map('map', {
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"paystack.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (response.data.status === 'success') {
            authorizationUrl = response.data.authorization_url; // Redirect the user to Paystack's payment page
            window.location.href = authorizationUrl;
          } else {
            (0, _alerts.showAlert)('error', 'Something went wrong while initializing payment');
          }
          _context.next = 12;
          break;
        case 8:
          ...
          (0, _alerts.showAlert)('error', _context.t0.response.data.message || 'An error occurred');
        case 12:
        case "end":
          return _context.stop();
      }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"reviews.js":[function(require,module,exports) {
"use strict";
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "http://127.0.0.1:3000/api/v1/tours/".concat(tour, "/reviews"),
            data: {
              review: review,
              rating: rating,
              tour: tour,
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Review Uploaded Successfully!');
            window.setTimeout(function () {
...
var reviewDataForm = document.querySelector('.review__form');
